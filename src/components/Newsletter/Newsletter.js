  ...
  return (
    <section className="bg-[#282828] px-3 py-12">
      <div className="max-w-[1320px] mx-auto  flex flex-col justify-center items-center text-white">
        <h2 className="text-2xl text-[#d02027] uppercase font-medium tracking-widest">Newsletter</h2>
        ...
        <div className="flex justify-between items-center input input-bordered w-2/4 text-gray-700">
          <input
            type="text"
